    ...
    <section className="max-w-8xl my-10 mx-auto px-4 w-full " id="formulario">
      ...
      >
        ...
        <div className="flex flex-row gap-2 w-full justify-between">
          ...
          <div className="flex flex-col gap-2 w-full">
            <label className="text-gray-800 text-sm font-bold" htmlFor="email">
              Email
            </label>
            <input
              name="email"
        ...
        <div className="flex flex-row gap-2 w-full justify-between">
          <div className="flex flex-col gap-2 w-full">
            <label className="text-gray-800 text-sm font-bold" htmlFor="phone">
              Teléfono / Celular
            </label>
            <input
              name="phone"
        ...
        <div className="w-full justify-center my-2 flex flex-col items-center">
          <p className="text-gray-800 text-lg text-center">
            Nuestra política de pagos es bajo la condición de 50% de anticipo y
            50% a contraentrega.
          </p>
          <div className="flex gap-10">
            <Radio
