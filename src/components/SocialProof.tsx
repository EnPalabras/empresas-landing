export default function SocialProof() {
  return (
    <section
      className="w-full my-10 flex flex-row items-center justify-between max-w-4xl"
      id="social-proof"
    >
      <div
        className="w-3/5 hidden md:block max-w-[400px]
      ...
      <div
        ...
        text-center w-full mx-auto px-4 sm:px-6 lg:px-8
      "
      >
        ...
        <div className="">
          <div className="max-w-screen-xl px-4 mt-10 py-6 mx-auto text-center ">
            <dl
              className="max-w-screen-md flex flex-row justify-between gap-8 
