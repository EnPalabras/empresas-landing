export default function Footer() {
  return (
    <footer className="w-full md:pt-10 mx-auto bg-gray-900 text-white">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="mb-6 md:mb-0">
            ...
            >
              <img
                ...
                className="h-20 rounded-md mx-auto invert"
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-14 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-400 font-medium">
                <li className="mb-4">
                  <a href="https://enpalabras.com.ar" className="">
                    Tienda Online
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="text-gray-400 font-medium">
                <li className="mb-4">
                  <a href="#preguntas" className=" ">
                    Preguntas
                  </a>
                </li>
                <li>
                  <a href="mailto:enpalabrass@gmail.com" className="">
                    Contactanos
                  </a>
                </li>
              </ul>
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm my-2 text-gray-400 sm:text-center">
            © 2023{' '}
            <a href="https://enpalabrass.com.ar" className="">
              En Palabras™
            </a>
          </span>
